    ...
    <div className="min-h-screen bg-blinkit-bg flex items-center justify-center px-4">
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-blinkit-border p-8 animate-fade-in-up">
          ...
          {/* Instructions */}
          <div className="bg-blinkit-green rounded-xl p-4 mb-6 text-white">
            <h3 className="font-bold mb-2 flex items-center text-sm text-white">
              <svg className="w-5 h-5 text-white mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              What's next?
            </h3>
            <ol className="text-sm text-white/80 space-y-1.5 ml-7">
